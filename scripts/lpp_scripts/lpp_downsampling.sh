...
DOWNSAMPLE_METHODS=("legacy_last" "legacy_average" "lanczos")
...
for SUBJECT in "${SUBJECTS[@]}"; do
    ...
    for METHOD in "${DOWNSAMPLE_METHODS[@]}"; do
        ...
        python ../../training_files/train_lpp_all.py \
            --data_dir $DATA_DIR \
            --subject $SUBJECT \
            ...
            --wandb_project_name lpp_downsampling_type_final_combined_2
        
        echo "  Completed training for layer 11, subject $SUBJECT, method $METHOD"
    done
done
